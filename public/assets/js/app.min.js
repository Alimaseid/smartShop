...
class ThemeCustomizer {
    ...
    initScrollBars() {
        ...
        document
            .querySelector(".left-side-menu .scrollbar")
    ...
    initSwitchListener() {
        ...
        document
            .querySelectorAll("input[name=data-sidebar-user]")
            .forEach(function (element) {
                element.addEventListener("change", function (e) {
    ...
    setSwitchFromConfig() {
        ...
        if (config) {
            var layoutColorSwitch = document.querySelector(
                "input[type=checkbox][name=data-bs-theme][value=" +
                    config.theme +
                    "]"
            );
            ...
            var leftbarSizeSwitch = document.querySelector(
                "input[type=checkbox][name=data-sidebar-size][value=" +
                    config.sidebar.size +
                    "]"
            );
            var leftbarUserSwitch = document.querySelector(
                "input[type=checkbox][name=data-sidebar-user]"
            );
            ...
            if (leftbarUserSwitch && config.sidebar.user.toString() === "true")
                leftbarUserSwitch.checked = true;
        }
    }
...
(function ($) {
    ...
    function initPortletCard() {
        ...
        $(document).on("click", portletRefresher, function (ev) {
            ...
            $portlet.append(
                '<div class="card-disabled"><div class="card-portlets-loader"><div class="spinner-border text-primary m-2" role="status"></div></div></div>'
            );
