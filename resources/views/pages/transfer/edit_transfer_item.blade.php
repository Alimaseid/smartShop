...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="editTransfer-{{ $transfer->id }}" method="post">
                    @csrf
                <div class="card-header border-bottom bg-transparent">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="header-title mb-0">Edit Transfer Form</h5>
                        </div>

                        <div class="col-lg-4">
                        </div>
                        <div class="col-lg-2">
                            <input type="date" name="date" required class="form-control" value="{{ $transfer->created_at->toDateString() }}" id="">
                        </div>
                    </div>
                    ...
                    <div class="row">
                         <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" step="any" required name="rf_number" value="{{ $transfer->rf_number }}">
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <label for="">From</label>
                                    <select class="form-control" name="location_from" required data-toggle="select2">
                                        <option value="{{ $transfer->location_from }}">{{ $transfer->from->name }}</option>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <select class="form-control" name="location_to" required data-toggle="select2">
                                        <option value="{{ $transfer->location_to }}">{{ $transfer->to->name }}</option>
                                        @forelse ($locations as $location )
                                            <option value="{{ $location->id }}">{{ $location->name }}</option>
                                        @empty
                                        @endforelse
                         ...
                         <div class="col-lg-4">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" step="any" required value="{{ $transfer->transferred_by }}" name="transferred_by">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="col-lg-12 col-sm-12 pb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $transfer->received_by }}" step="any" required  name="received_by">
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-1">
                                                                    <h5 class="m-0">{{ $detail->item_name }}</h5>
                            ...
                            <div class="col-lg-4">
                                <div class="row pb-2">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="remark" rows="5" class="form-control" placeholder="Remark...">{{ $transfer->remark }}</textarea>
                                    </div>
