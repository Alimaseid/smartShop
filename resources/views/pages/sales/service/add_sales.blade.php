...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="service-sales" method="post">
                        @csrf
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            ...
                                            <input type="text" class="form-control" step="any" name="invoice_no"
                                                value="MN-{{ rand(10000, 99999) }}">
                                        </div>
                                                ...
                                                <table class="table table-centered border table-nowrap mb-lg-0">
                                                    <thead class="bg-light">
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <input type="number" onchange="getTotal()" id="price"
                                                                    step="any" min="0" class="form-control"
                                                                    placeholder="U-Price">
                                                            </th>
                                                            <th>
                                                                <input type="number" id="total" step="any"
                                        ...
                                        <div class="row pb-2">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="number" class="form-control" step="any"
                                                    onchange="getTotal()" min="0" name="tax" id="tax_value"
                                                    value="0">
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="">Discount%</label>
                                                <input type="number" class="form-control" step="any"
                                                    onchange="getTotal()" max="100" name="discount" id="discount"
                                                    value="0">
