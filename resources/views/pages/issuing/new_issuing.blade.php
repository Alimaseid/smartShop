...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">New Issuing</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">ERP</a></li>
                            <li class="breadcrumb-item"><a href="/">Inventory</a></li>
                            <li class="breadcrumb-item"><a href="/issuings">Issuing</a></li>
                            <li class="breadcrumb-item active">New Issuing</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="issuing" method="post">
                        @csrf
                        <div class="card-header border-bottom bg-transparent">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h5 class="header-title mb-0">Issuing Form</h5>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-6">
                                            <label for="">Issuing No#</label>
                                            <input type="text" class="form-control" step="any" required
                                                name="issuing_no" value="MNI-{{ rand(10000, 99999) }}">
                                        </div>
                                        <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="col-lg-4">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <select name="received_by" class="form-control" id=""
                                            @forelse ($employees as $employee) data-toggle="select2">
                                                        ...
                                                        <tr>
                                                            <th style="width: 50%;">
                                                                <select class="form-control" name="" id="item_id"
                                                                    onchange="getItemInfo()" data-toggle="select2">
                                                            ...
                                                            <th>
                                                                <input type="number" onchange="getTotal()" id="quantity"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row pb-2">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="remarks" rows="5" class="form-control" placeholder="Remark..."></textarea>
                                            </div>
                                                ...
                                                <table class="table table-centered border mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <input type="hidden" name="total" id="all_total_in">

                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <div class="row m-2">
                                                    <button style="float: right;" disabled id="submiter"
