            ...
            <div class="page-title-box">
                <h4 class="page-title">
                    <button class="btn btn-info btn-sm" onclick="getForm()">
                        Requisition <i class="fa fa-plus"> </i></button></h4>
        ...
        <div class="col-lg-8 col-xl-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="requisition" method="post" class="parsley-examples">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-2">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="requisition_no" required id="inputAddress" value="{{ rand(100000,999999) }}">
                                </div>
                            </div>
                        </div>
                        {{-- <div class="row p-2">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-2">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="Note..."></textarea>
                                </div>
                            </div>
                        </div> --}}
        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush text-primary nav nav-pills navtab-bg">
                        ...
                        <li class="list-group-item p-3 nav-item">
                            <a href="#{{ $rqs->id }}" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                <i class="mdi mdi-cog me-1"></i><small>{{ $rqs->created_at->toDateString() }}</small>, <b class="text-primary">{{ $rqs->requisition_no}}</b>
                            </a>
                        </li>
                        @empty
                   ...
                   {{ $requisitions->render('pagination::bootstrap-4') }}
