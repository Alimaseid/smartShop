...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">ADD New Sales</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">ERP</a></li>
                        <li class="breadcrumb-item"><a href="/">Inventory</a></li>
                        <li class="breadcrumb-item"><a href="/sales-quotation">Sales Quotation</a></li>
                        <li class="breadcrumb-item active">ADD Sales Quotation</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="sales-quotation" method="post">
                    @csrf
                <div class="card-header border-bottom bg-transparent">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5 class="header-title mb-0">ADD New Sales Quotation Form</h5>
                        </div>
                         ...
                         <div class="col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" step="any" name="invoice_no" value="MNQ-{{ rand(10000,99999) }}">
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <label for="">Expiration Date</label>
                                    <input type="date" name="expiration_date" class="form-control" value="{{ now()->toDateString() }}" id="">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="date" name="due_date" class="form-control" required id="">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-centered border table-nowrap mb-lg-0" >
                                            <thead class="bg-light">
                                                <tr>
                                                    <th style="width: 35%;">
                                                       <select class="form-control"  id="item_id" onchange="getItemInfo()" data-toggle="select2">
                                                    ...
                                                    <th>
                                                        <input type="number" onchange="getTotal()" id="price" step="any" min="0" class="form-control" placeholder="U-Price" >
                                                    </th>
                                                    <th>
                            ...
                            <div class="col-lg-4">
                                <div class="row pb-2">
                                    <div class="col-lg-6">
                                        <label for="">Tax</label>
                                        <input type="number"  class="form-control" step="any"  onchange="getTotal()" min="0" name="vat" id="tax_value" value="0">
                                    </div>
                                    <div class="col-lg-6">
