                    ...
                    <div class="page-title-box">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="/vendor">Vendors</a></li>
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <address>
                                        Currunt Balance<br>
                                        <i><b style="color: black">{{ number_format($vendor->total_balance,2)  }}</b></i><br>
                                    </address>
                                </div> <!-- end col -->
                            </div>
                            <!-- end row -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($ledger->purchase_id)
                                                            @forelse ($ledger->purchase->details as $detail)
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="float-end">
                                        ...
                                        <h3>{{ number_format($vendor->total_balance,2) }} Birr</h3>
                                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="editPay-{{ $ledger->payment->id }}" id="editForm" method="post" class="parsley-examples">
                                        @csrf
                                        <div class="row pb-2">
                                            <div class="col-lg-6">
